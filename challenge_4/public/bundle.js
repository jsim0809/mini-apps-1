...
var Board = ({
  board
}) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("table", null, [5, 4, 3, 2, 1, 0].map(rowNum => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, board.map(column => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, column[rowNum] ? column[rowNum] : ' ')))));
...
var WhoseTurn = ({
  redTurn
}) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "It is ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("u", null, redTurn ? "Red Player's" : "Yellow Player's")), " turn.");

/* harmony default export */ __webpack_exports__["default"] = (WhoseTurn);
...
class App extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  winningBoard(board) {
    ...
    ['R', 'Y'].forEach(letter => {
      for (var j = 0; j < 6; j++) {
        if (board[3][j] === letter) {
          if (board[0][j] === letter && board[1][j] === letter && board[2][j] === letter || board[1][j] === letter && board[2][j] === letter && board[4][j] === letter || board[2][j] === letter && board[4][j] === letter && board[5][j] === letter || board[4][j] === letter && board[5][j] === letter && board[6][j] === letter) {
            result = true;
          }
        }
      }
    ...
    ['R', 'Y'].forEach(letter => {
      for (var i = 0; i < board.length; i++) {
        for (var j = 0; j < 6; j++) {
          if (board[i][j] === letter) {
            if (board[i + 1][j + 1] === letter && board[i + 2][j + 2] === letter && board[i + 3][j + 3] === letter || board[i - 1][j - 1] === letter && board[i - 2][j - 2] === letter && board[i - 3][j - 3] === letter) {
              result = true;
            }
          }
        }
  ...
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Connect Four"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Get 4 in a row to win!"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_WhoseTurn_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], {
